...
if __name__ == "__main__":
    ...
    for i in range(util.NUM_SIMULATIONS):
        ...
        dataset2000.to_csv(
            "data/synthetic_" + str(i).zfill(3) + "_2000.csv", index=False
        )
        ...
        dataset10000.to_csv(
            "data/synthetic_" + str(i).zfill(3) + "_10000.csv", index=False
        )
        ...
        dataset_test.to_csv(
            "data/synthetic_" + str(i).zfill(3) + "_test.csv", index=False
        )
